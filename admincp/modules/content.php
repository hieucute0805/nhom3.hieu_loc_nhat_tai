 	...
 	<div class="box_contains">
 		<?php
				if(isset($_GET['quanly'])&&$_GET['ac']){
					...
					}elseif(($tam == 'taikhoan')&&($tam1 == 'lietke')){
						
						include('modules/ql_taikhoan/lietke.php');
					}elseif(($tam == 'taikhoan')&&($tam1 == 'sua')){
						
						include('modules/ql_taikhoan/sua.php');
					}elseif(($tam == 'taikhoan')&&($tam1 == 'them')){
						
						include('modules/ql_taikhoan/them.php');
					}
						?>
